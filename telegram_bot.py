...
from secondary_functions import post_images


def post_bot(folder_address, token, chat_id, delay_time_sec=14400):
    ...
    while True:
        ...
        for image in images_collection:
            post_images(tele_bot, chat_id, image)
...
if __name__ == '__main__':
    ...
    post_bot(folder_address, bot_token, chat_id, delay_time)
